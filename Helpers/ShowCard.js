...
const ShowCard = ({children}) => {
    ...
    return (
        <ShowCard_Cont.Provider value={{selectionUpdate, setSelectionUpdate,show_FullCard, setShow_FullCard,card_selected, setCard_selected,show_EditCard, setShow_EditCard,show_CreateCard, setShow_CreateCard}}>
            {children}
