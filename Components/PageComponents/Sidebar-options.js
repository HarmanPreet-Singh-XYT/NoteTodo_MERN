...
const SidebarOptions = () => {
  ...
  return (
    ...
    <section className="options">
                <button name='overview' onClick={(e)=>setSelectedButton(e.target.name)} className={selectedButton==="overview" ? "overview bt side-selected-btn" : "overview bt"}><span name='overview' className="lg"><i className="fa-solid fa-city"></i></span>Overview</button>
