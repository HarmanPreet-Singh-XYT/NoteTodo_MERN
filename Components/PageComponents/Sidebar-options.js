...
const SidebarOptions = () => {
  ...
  return (
    ...
    <section className="options">
                ...
                <button disabled name='output' onClick={(e)=>setSelectedButton(e.target.name)} className={selectedButton==="output" ? "output bt side-selected-btn" : "output bt"}><span className="lg"><i className="fa-solid fa-fire"></i></span>Output</button>
                <button disabled name='support' onClick={(e)=>setSelectedButton(e.target.name)} className={selectedButton==="support" ? "support bt side-selected-btn" : "support bt"}><span className="lg"><i className="fa-solid fa-comments"></i></span>Support</button>
    </section>
    <hr className="hrline"/>
    </>
  )
